<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="logo">
      <el-input v-model="dataForm.logo" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="descript">
      <el-input v-model="dataForm.descript" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    <el-form-item label="${column.comments}" prop="firstLetter">
      <el-input v-model="dataForm.firstLetter" placeholder="${column.comments}"></el-input>
    </el-form-item>
